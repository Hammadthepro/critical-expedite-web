        ...
        <section className="relative pt-40 pb-20 overflow-hidden">
          ...
          <div className="container-custom px-4 relative z-10 text-center">
            ...
            <p className="text-xl text-primary-foreground/80 max-w-2xl mx-auto">
              Your trusted asset-based logistics partner with over 15 years of excellence in freight transportation.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-8">
                  Today, we serve businesses nationwide, from small operations to major enterprises, all with the same commitment to excellence that started our journey over 15 years ago.
                </p>
